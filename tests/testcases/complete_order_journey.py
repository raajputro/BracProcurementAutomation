...
def test_2_identify_first_approver_for_created_requisition(page):
    ...
    Steps:
        ...
        6. Log out from the current session to complete the test flow.
    """
    # logger.step("Test 2: Finding approver of the requisition...")
    ...
    # logger.step("APPROVER ID:", approver_id)
...
def test_3_login_as_first_approver_and_approve_requisition(page):
    ...
    # logger.step("Test 3: Logging in as approver and approving requisition...")
    proc_login_page = ProcurementLoginPage(page)
    proc_login_page.perform_login(
        given_url=proj_url,
...
def test_6_verify_requisition_is_approved(page, new_tab):
    ...
    # logger.step("REQ STATUS:", req_status)
...
@pytest.mark.reporting(
    functional_specification="test_1",
    test_description="""Test Case 7: Marketplace order initiation process in the Test environment.
...
def test_7_initiate_marketplace_order(page, new_tab):
    # def test_7_initiate_marketplace_order(page, new_tab, logger):
    """
    ...
    # logger.step("Global order_reference_number", order_reference_number)
    checkout_page.wait_for_timeout(2000)
...
def test_8_approve_marketplace_order(page):
    # def test_8_approve_marketplace_order(page, logger):
    """
...
def test_9_retrieve_vendor_credentials_for_marketplace_order(page):
    ...
    # logger.step("Global vendor login ID:", vendor_login_id)
...
def test_10_vendor_acknowledges_marketplace_order(page):
    ...
    # logger.step("Generate framework order number", framework_order_no)
...
def test_12_receiver_receives_marketplace_item(page):
    ...
    # logger.step("Print generated challan number for receiver: ", challan_num_for_receiver)
...
def test_13_order_initiator_receives_marketplace_item(page):
    ...
    # logger.step("Print generated challan number for order initiator: ", challan_num_for_order_initiator)
    receivable_order_list_page.all_item_select.click()
    receivable_order_list_page.wait_for_timeout(5000)
    ...
    # logger.step("Print generated challan number for order initiator: ", challan_num_for_order_initiator_2)
...
def test_15_create_and_submit_bill_for_received_marketplace_item(page):
    ...
    # logger.step(f"Bill Recommender 1: {bill_recommender_1}")
...
def test_16_first_recommender_approves_marketplace_bill(page, new_tab):
    ...
    # logger.step(f"Bill Recommender 2: {bill_recommender_2}")
...
def test_17_second_recommender_approves_marketplace_bill(page, new_tab):
    ...
    # logger.step(f"Bill Approver : {bill_recommender_3}")
...
def test_18_vendor_bill_approver_approval_process_in_procurement(page, new_tab):
    ...
    # logger.step("Bill STATUS:", bill_status)
