...
from pages.erp_procurement.tender_initiation_list import TenderInitiationList
from pages.erp_procurement.tender_details_page import TenderDetails
from pages.erp_procurement.create_work_order import CreateWorkOrder
from pages.erp_procurement.purchase_order_list import PurchaseOrderList
from pages.erp_procurement.purchase_order_details_information import PurchaseOrderDetailsInformation
from pages.e_tender.create_noal import CreateNoal
from pages.e_tender.e_tender_details_page import ETenderDetails
from pages.e_tender.eTender_login import EtenderLoginPage
from pages.e_tender.financial_evaluation import FinancialEvaluation
from pages.e_tender.participate_in_tender import PerticipateTenderList
from pages.e_tender.prepare_short_list import PrepareShortList
