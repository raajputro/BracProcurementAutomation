...
proj_mf_user = os.getenv("test_mf_user")
proj_mf_user_branch = os.getenv("test_mf_user_branch")
...
#======================================================================================================================
# # ============================================ Test Cases onwards =============================================== # #
def test_0_login_to_create_requisition(page):
    """
    This test is for login
    and navigating to microfinance > savings > compulsory savings > VO savings collection page
    take a screenshot
    logout
    """
    ...
    s_page.perform_login(
        given_url=proj_url,
        user_name=proj_mf_user,
        pass_word=proj_pass,
        branch_code=proj_mf_user_branch
    )

    main_navigation = "Microfinance"
    sub_navigation = ["Savings", "Compulsory Savings", "VO Savings Collection"]
    s_page.navigate_to_page(main_nav_val=main_navigation, sub_nav_val=sub_navigation)
    s_page.get_full_page_screenshot("MF User Login")
...
def test_1_login_to_create_requisition(page):
    """
    This test is for login
    and navigating to procurement > requisition > create requisition page
    """
    s_page  = LoginPage(page)
    s_page.perform_login(
        given_url=proj_url,
    ...
    main_navigation = "Procurement"
    sub_navigation = ["Requisition","Create Requisition"]
    s_page.navigate_to_page(main_nav_val=main_navigation, sub_nav_val=sub_navigation)
    s_page.get_full_page_screenshot("Procurement User Login")


def test_2_create_and_submit_requisition(page):
    """
    This test is to create a requisition with a set of data
    and submit it
    """
    print("Test 2: Creating requisition...")
...
def test_3_find_approver_of_the_requisition(page):
