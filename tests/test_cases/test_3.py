...
#     approver_id_4 = str(int(l3_page.find_approver_id()))
...
def test_18_vendor_bill_recommender2_approval(page, new_tab):
        ...
        global approver_id_5
        approver_id_5 = l3_page.find_approver_id()
        print("Test 18: Vendor bill approval...{}".format(approver_id_5))
    ...
    #     b_page = BillDetails(new_page)
    #     b_page.approve_bill()
    #     b_page.get_full_page_screenshot('full_page_screenshot_43')
