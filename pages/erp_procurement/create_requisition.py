...
class CreateRequisitionPage(BasicActions):
    ...
    #     #slecting Requisition For as Head Office
    #     self.head_office_selector.click()        # selecting Head Office
    #     office_value = self.office_input.input_value()  # get the value attribute
    ...
    #     #slecting Requisition For as Other Office
    #     self.other_office_selector.click()        # selecting Head Office
    #     self.officeInfoDiv_arrow.click()     # clicking on office name drop down
    #     self.page.get_by_text(office_name).click()
    #     office_info_value = self.office_info_input.input_value()
    #     print(f"Office Type is auto-filled with: '{office_info_value}'")        
    #     office_type_value = self.office_type_input.input_value()
    #     print(f"Office Type is auto-filled with: '{office_type_value}'")
    #     self.project_name_dropdown_selector.click()     # clicking on project name drop down
    #     self.page.get_by_text(project_name).click()
    ...
    def setting_requisition_for_HO(self, project_name):
        ...
        Office Info, Office Type, Program, and Project End Date.
        """
        try:
