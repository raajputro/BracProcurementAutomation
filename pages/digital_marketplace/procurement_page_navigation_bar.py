...
class ProcurementPageNavigationBar(BasicActionsDM):
    def __init__(self, page, logger=None):
        ...
        self.requisition_assign = page.locator("#wrapper").get_by_text("Requisition Assign",
                                                                       exact=True)  # will show assign unassign and others options
        ...
        self.item_receive = page.locator("#wrapper").get_by_role("listitem").filter(
            has_text="Item Receive Item Receive").locator("div")
        # under item receive
        ...
        self.bill_payable = page.locator("#wrapper").get_by_role("listitem").filter(
            has_text="Bill Payable Create Vendor").locator("div")
        # under bill payable
